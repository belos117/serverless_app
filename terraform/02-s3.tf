...
resource "local_file" "scripts_js" {
  content = templatefile("../static/scripts.template.js", {
    api_endpoint = "${aws_api_gateway_stage.gateway_stage.invoke_url}/student"
  })
...
resource "aws_s3_object" "javascript" {
  ...
  etag         = filemd5("../static/scripts.template.js")
